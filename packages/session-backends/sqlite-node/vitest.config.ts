...
export default defineConfig({
	...
	resolve: {
		alias: [
			{ find: /^@aos-agent\/telemetry$/, replacement: telemetryIndex },
			{ find: /^@aos-agent\/agent-core\/session\/testing$/, replacement: agentSessionTesting },
			{ find: /^@aos-agent\/agent-core\/node$/, replacement: agentNode },
			{ find: /^@aos-agent\/agent-core$/, replacement: agentIndex },
			{ find: /^@aos-agent\/ai$/, replacement: aiIndex },
		],
	},
});
