...
For non-Windows cross-builds, or for custom Windows toolchains, set `AOS_AGENT_TUI_WIN32_TOOLCHAIN=mingw` and provide MinGW-compatible compilers:

```sh
AOS_AGENT_TUI_WIN32_TOOLCHAIN=mingw \
