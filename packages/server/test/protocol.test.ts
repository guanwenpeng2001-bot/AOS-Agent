import type { Api, AssistantMessage, Model, ToolCall, ToolResultMessage, UserMessage } from "@aos-agent/ai";
import { encodeServerMessage, PROTOCOL_VERSION } from "@aos-agent/protocol";
