import type { JsonValue, ProtocolErrorCode } from "@aos-agent/protocol";

export type AosServerOperationErrorCode = Extract<
	ProtocolErrorCode,
...
export class AosServerError extends Error {
	readonly code: AosServerOperationErrorCode;
	readonly details: JsonValue | undefined;

	constructor(code: AosServerOperationErrorCode, message: string, details?: JsonValue) {
		super(message);
...
export class SessionBusyError extends AosServerError {
...
export class SessionLockedError extends AosServerError {
...
export class SessionNotFoundError extends AosServerError {
...
export class NotImplementedError extends AosServerError {
	constructor() {
