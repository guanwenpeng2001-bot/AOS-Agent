import type { StopReason, Usage } from "@aos-agent/ai";
import "../messages.ts";
import type { AgentMessage } from "../../types.ts";
import type { Session } from "./session.ts";
import type { FoundationRecord } from "./durable/types.ts";
import type { ExecutionCorrelation } from "../foundation/identity.ts";
...
export type LogItem =
	...
	| { kind: "foundation"; seq: number; record: FoundationRecord }
