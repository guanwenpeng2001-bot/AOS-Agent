...
export default defineConfig({
	...
	resolve: {
		alias: [
			{ find: /^@aos-agent\/telemetry$/, replacement: telemetrySrcIndex },
			{ find: /^@aos-agent\/agent-core$/, replacement: agentSrcIndex },
			{ find: /^@aos-agent\/ai$/, replacement: aiSrcIndex },
			{ find: /^@aos-agent\/ai\/compat$/, replacement: aiSrcCompat },
		],
	},
});
