...
/**
 * Migrate sessions from ~/.aos-agent/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.aos-agent/agent/ instead of
 * ~/.aos-agent/agent/sessions/<encoded-cwd>/. This migration moves them
 * to the correct location based on the cwd in their session header.
 *
 * See: (see package docs)
 */
 ...
 * Note: tools/ may contain fd/rg binaries extracted by aos, so only warn if it has other files.
 */
