 ...
 *
 * These are the internal, fine-grained classification; the Automation Host
 * wire surfaces the PR error-contract codes (`mcp_content_invalid`,
 * `mcp_content_limit_exceeded`) through the mapper in `mcp-error-codes.ts`.
 */
