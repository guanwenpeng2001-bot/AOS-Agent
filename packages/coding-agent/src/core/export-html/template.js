    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="aos-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="aos-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'aos-share:v1:sidebar-width';
