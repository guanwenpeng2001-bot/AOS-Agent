...
import type { DefaultProjectTrust } from "../runtime/settings-manager.ts";
import {
...
function formatProjectTrustPrompt(cwd: string): string {
	return `Trust project folder?\n${cwd}\n\nThis allows AOS Agent to load ${CONFIG_DIR_NAME} settings and resources, install missing project packages, and execute project extensions.`;
}
