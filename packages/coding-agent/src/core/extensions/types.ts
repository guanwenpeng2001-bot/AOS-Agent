...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `aos-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "aos-agent";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown AOS Agent and exit. Available in all contexts. */
	shutdown(): void;
...
export interface BeforeAgentStartEvent {
	...
	systemPrompt: string;
	/** Structured options used to build the system prompt. Extensions can inspect this to understand what AOS Agent loaded without re-discovering resources. */
...
export interface ExtensionAPI {
	...
	/** Register a transformer for user and assistant Markdown before AOS Agent renders it in the interactive transcript. */
...
export interface ExtensionRuntimeState {
	...
	/** Native @aos-agent/ai provider registrations queued during extension loading, processed when runner binds. */
...
/**
 * Action implementations for AOS Agent API methods.
