...
export class RemoteSession {
	...
	private constructor(client: AosClient, options: RemoteSessionOptions = {}) {
		this.#client = client;
	...
	static async open(client: AosClient, sessionId: string, options: RemoteSessionOptions = {}): Promise<RemoteSession> {
