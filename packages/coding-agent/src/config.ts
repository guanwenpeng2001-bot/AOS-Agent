...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from the AOS Agent release channel for your platform.`;
	}
...
export function getPackageDir(): string {
	...
	const envDir = process.env.AOS_AGENT_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json aosAgentConfig)
// =============================================================================
...
const aosAgentConfigName: string | undefined = pkg.aosAgentConfig?.name;
export const PACKAGE_NAME: string = pkg.name || "aos-agent";
export const APP_NAME: string = aosAgentConfigName || "aos";
export const APP_TITLE = "AOS Agent";
...
/** Get the share viewer URL for a gist ID. Requires AOS_AGENT_SHARE_VIEWER_URL (no default host). */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.AOS_AGENT_SHARE_VIEWER_URL?.trim();
	if (!baseUrl) {
		return "";
	}
	return `${baseUrl.replace(/\/?$/, "/")}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.aos-agent/agent/*)
// =============================================================================
