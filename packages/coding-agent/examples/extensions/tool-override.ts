 ...
 * - Routing tool calls to remote systems (e.g., ssh-remote)
...
import type { TextContent } from "@aos-agent/ai";
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "aos-agent";
...
export default function (agent: ExtensionAPI) {
	...
	agent.registerCommand("read-log", {
