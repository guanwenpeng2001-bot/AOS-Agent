 ...
 * Delegates to AOS Agent's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   aos -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (agent: ExtensionAPI) {
	agent.registerProvider("gitlab-duo", {
