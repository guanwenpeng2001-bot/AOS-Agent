 ...
 *
 * Usage:
 *   aos -e ./built-in-tool-renderer.ts
 */

import type { BashToolDetails, EditToolDetails, ExtensionAPI, ReadToolDetails } from "aos-agent";
import { createBashTool, createEditTool, createReadTool, createWriteTool } from "aos-agent";
