 ...
 *
 * Usage: aos --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@aos-agent/tui";

export default function (agent: ExtensionAPI) {
	agent.registerCommand("overlay-test", {
