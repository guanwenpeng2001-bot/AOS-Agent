...
Play DOOM as an overlay in AOS Agent. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
aos --extension ./examples/extensions/doom-overlay
```
...
- Upstream DOOM overlay provenance: [UPSTREAM.md](../../../../../../UPSTREAM.md)
