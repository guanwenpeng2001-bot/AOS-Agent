 ...
 * (logo + keybinding hints) with a custom component showing the AOS Agent branding.
 */

import type { ExtensionAPI, Theme } from "aos-agent";
import { VERSION } from "aos-agent";
