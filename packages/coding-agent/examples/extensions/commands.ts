 ...
 * Commands Extension
 *
 * Demonstrates the agent.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "aos-agent";

export default function commandsExtension(agent: ExtensionAPI) {
	agent.registerCommand("commands", {
