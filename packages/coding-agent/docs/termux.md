...
AOS Agent runs on Android via [Termux](https://termux.dev/), a terminal emulator and Linux environment for Android.
...
# Install aos
npm install -g --ignore-scripts aos-agent

# Create config directory
mkdir -p ~/.aos-agent/agent
...
Create `~/.aos-agent/agent/AGENTS.md` to help the agent understand the Termux environment:
