> AOS Agent can create prompt templates. Ask it to build one for your workflow.
...
AOS Agent loads prompt templates from:

- Global: `~/.aos-agent/agent/prompts/*.md`
- Project: `.aos-agent/prompts/*.md` (only after the project is trusted)
- Packages: `prompts/` directories or `agent.prompts` entries in `package.json`
