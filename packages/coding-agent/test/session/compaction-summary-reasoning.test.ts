...
import type { AssistantMessage, Model } from "@aos-agent/ai";
...
vi.mock("@aos-agent/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@aos-agent/ai/compat")>();
	return {
		...actual,
