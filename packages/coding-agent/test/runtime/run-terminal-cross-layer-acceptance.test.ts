...
describe("canonical Run terminal cross-layer acceptance", () => {
	...
	it.each([
		...
		{ name: "external-tool-route-denied", options: { outcome: "failed", terminalErrorCode: "external_tool_route_denied" }, eventType: "run.failed", status: "failed", code: "external_tool_route_denied" },
