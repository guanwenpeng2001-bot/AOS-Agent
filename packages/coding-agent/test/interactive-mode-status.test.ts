...
"[Extensions]
  @scope/aos-scoped, answer.ts, cli-extension.ts, HazAT/aos-interactive-subagents, HazAT/aos-interactive-subagents:subagents, local-index, aos-markdown-preview, user-index"`);
	});
