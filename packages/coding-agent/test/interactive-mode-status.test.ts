...
import { type AutocompleteProvider, CombinedAutocompleteProvider } from "@aos-agent/tui";
...
describe("InteractiveMode.showLoadedResources", () => {
	...
	function createExtensionFixtures(): ExtensionFixture[] {
		return [
			{
				path: "/tmp/project/.aos-agent/extensions/answer.ts",
				sourceInfo: createSourceInfo("/tmp/project/.aos-agent/extensions/answer.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.aos-agent/extensions",
				}),
			},
			{
				path: "/tmp/project/.aos-agent/extensions/local-index/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.aos-agent/extensions/local-index/index.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.aos-agent/extensions",
			...
			{
				path: "/tmp/project/.aos-agent/npm/node_modules/aos-markdown-preview/extensions/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.aos-agent/npm/node_modules/aos-markdown-preview/extensions/index.ts", {
					source: "npm:aos-markdown-preview",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.aos-agent/npm/node_modules/aos-markdown-preview",
				}),
			},
			{
				path: "/tmp/project/.aos-agent/npm/node_modules/@scope/aos-scoped/extensions/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.aos-agent/npm/node_modules/@scope/aos-scoped/extensions/index.ts", {
					source: "npm:@scope/aos-scoped",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.aos-agent/npm/node_modules/@scope/aos-scoped",
				}),
			},
			{
				path: "/tmp/project/.aos-agent/git/github.com/HazAT/aos-interactive-subagents/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.aos-agent/git/github.com/HazAT/aos-interactive-subagents/extensions/index.ts",
					{
						source: "git:github.com/HazAT/aos-interactive-subagents",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.aos-agent/git/github.com/HazAT/aos-interactive-subagents",
					},
				),
			},
			{
				path: "/tmp/project/.aos-agent/git/github.com/HazAT/aos-interactive-subagents/extensions/subagents/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.aos-agent/git/github.com/HazAT/aos-interactive-subagents/extensions/subagents/index.ts",
					{
						source: "git:github.com/HazAT/aos-interactive-subagents",
						scope: "project",
						origin: "package",
...
"[Extensions]
  @scope/aos-scoped, answer.ts, aos-markdown-preview, cli-extension.ts, HazAT/aos-interactive-subagents, HazAT/aos-interactive-subagents:subagents, local-index, user-index"`);
	});
...
"[Extensions]
  main.ts"`);
	...
	test("package extensions still strip index.ts correctly (regression guard)", () => {
		...
		expect(normalizeRenderedOutput(fakeThis.loadedResourcesContainer)).toMatchInlineSnapshot(`
"[Extensions]
  aos-markdown-preview"`);
	});

	test("labels npm sibling extensions relative to the declaring package", () => {
		const extensions: ExtensionFixture[] = [
			{
				path: "/tmp/project/.aos-agent/npm/node_modules/primary-package/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.aos-agent/npm/node_modules/primary-package/index.ts", {
					source: "npm:primary-package",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.aos-agent/npm/node_modules/primary-package",
				}),
			},
			{
				path: "/tmp/project/.aos-agent/npm/node_modules/sibling-package/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.aos-agent/npm/node_modules/sibling-package/index.ts", {
					source: "npm:primary-package",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.aos-agent/npm/node_modules/primary-package",
...
"[Extensions]
  primary-package, primary-package:../sibling-package"`);
	...
	test("labels Windows npm sibling extensions relative to the declaring package", () => {
		const primaryPath = "C:\\Users\\me\\.aos-agent\\agent\\npm\\node_modules\\primary-package\\index.ts";
		const siblingPath = "C:\\Users\\me\\.aos-agent\\agent\\npm\\node_modules\\sibling-package\\index.ts";
		const baseDir = "C:\\Users\\me\\.aos-agent\\agent\\npm\\node_modules\\primary-package";
		const extensions: ExtensionFixture[] = [
			{
				path: primaryPath,
...
"[Extensions]
  project
    /tmp/project/.aos-agent/extensions/answer.ts
    /tmp/project/.aos-agent/extensions/local-index
    git:github.com/HazAT/aos-interactive-subagents
      extensions
      extensions/subagents
    npm:@scope/aos-scoped
      extensions
    npm:aos-markdown-preview
      extensions
  user
  ...
  path
	...
	test("shows context paths relative to cwd while preserving full external paths", () => {
		const home = homedir();
		const cwd = path.join(home, "Development", "aos-agent");
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			contextFiles: [{ path: path.join(home, ".aos-agent", "agent", "AGENTS.md") }, { path: path.join(cwd, "AGENTS.md") }],
		});
		...
		expect(output).toContain("~/.aos-agent/agent/AGENTS.md, AGENTS.md");
	...
	test("shows system prompt context paths before project context files", () => {
		...
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			systemPromptSource: { path: path.join(cwd, ".aos-agent", "SYSTEM.md") },
			appendSystemPromptSources: [{ path: path.join(cwd, ".aos-agent", "APPEND_SYSTEM.md") }],
	...
	test("shows full context paths when expanded", () => {
		...
		const output = renderAll(fakeThis.loadedResourcesContainer).replace(/\\/g, "/");
		expect(output).toContain("[Context]");
		expect(output).toContain("~/.aos-agent/agent/AGENTS.md");
		expect(output).toContain("~/Development/aos-agent/AGENTS.md");
		expect(output).not.toContain("~/.aos-agent/agent/AGENTS.md, AGENTS.md");
	});
