...
/**
 * Converts models.dev verified effort values into AOS Agent selectable thinking levels.
 * Values without an AOS Agent equivalent (`default` and JSON `null`) are intentionally
 * omitted.
 */
