/**
 * Temporary compatibility entrypoint preserving the legacy global API
 ...
 *
 * Existing apps switch imports from "@aos-agent/ai" to
 * "@aos-agent/ai/compat" unchanged; new code uses `createModels()`
...
export * from "./api/aos-messages.lazy.ts";
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@aos-agent/ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@aos-agent/ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@aos-agent/ai/providers/all" or `Models.getProviders()`. */
