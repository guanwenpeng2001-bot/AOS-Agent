...
const outputPath = join(tmpdir(), "aos-agent-browser-smoke.js");
const agentTreeshakeOutputPath = join(tmpdir(), "aos-agent-treeshake-smoke.js");
const errorLogPath = join(tmpdir(), "aos-agent-browser-smoke-errors.log");
