...
| `packages/coding-agent/src/core/migrations/execution-association.ts` | `packages/coding-agent/src/core/migrations/execution-association.ts` | migrations | The file is explicitly a read-only decoder for a historical cross-ledger association. |
